...
#define GRBL_VERSION "1.234f"
#define GRBL_VERSION_BUILD "2017080"

#define BIT4 0B00010000// 1 << 4 , that is the 4 th position from MSB ( Analog Pin 4 ) 
// Also the DDRC is the register for the Analog Pins 0 to 5 .
